...
-   We first discuss what we see as the benefits and challenges of developing open systems more generally in ecological systems.
    We then focus in on our ecological research system and discuss three components that we believe can transform our system from a reproducible system focused on open science to an open system ripe for asking generative ecological questions: i) data availability ii) a conceptual model and iii) access \[or something about support...knowledge can't be completely extracted away from system experts\].
