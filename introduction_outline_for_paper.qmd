...
-   However, science is ultimately about generating new knowledge.
    ...
    <!--# In the Argent paper, I appreciated the distinction or semantic nuance of "knowledge model" versus "concept model". Knowledge model feels slightly more concrete to me, so perhaps that applies here to, wrt framing this as development of an open information system or open knowledge system -->
...
-   We define an "open system" practically in terms of the goal that it seeks to achieve.
    ...
    <!--# Complementing RK's last point about a model or information system only being used by outsiders and therefore having little value to the people who build it, making sure that system is broad enough to be used beyond those "insiders" seems similarly important. I think this was referenced in the concept model best practices. -->

-   The concept of "open systems" are not new in their philosophy.
    The broad fields of "knowledge systems" and "information ecology" have thought deeply about how to integrate and synthesize multiple streams of ecological and environmental knowledge.
...
-   Our goal in this paper is one of practitioners and not philosophers.
    ...
    -   \[Other questions\]
    -   Who should the stakeholders, contributors, and expected beneficiaries be?
...
-   We first discuss what we see as the benefits and challenges of developing open systems more generally in ecological systems.
    ...
    <!--# I think the best practices in conceptual modeling have a place here. -->

    -   Figure 1: Make a figure with three components: reproducibility -\> conceptual model -\> infrastructure access

        -   Infrastructure access: How do partners access the data and the conceptual model?
            They don't use Github etc.

## Benefits of open information systems
...
## Challenges of open information systems
...
-   List of the challenges of open systems
    ...
    2.  Initial and continuing investments in building an open system
        ...
        <!--# right, I was going to add this! Perhaps because I have already read this doc once... Typical short grant cycles force us to always move on, trends in funding and the coming and going of particular programs force us to adjust research programs in ways that may not naturally emerge from the filled and empty parts of the knowledge system -->
    3.  The reticence of letting "non-experts" work in a system
        1.  Fear of getting "scooped".
        2.  Removes perceived ownership.
        3.  Fear of, or actual, loss of control of narrative.
        <!--# trendiness, homogenization, dilettantes, and safety: do others share a feeling of wariness of inspiring others to jump into a field with the risk of having essentially a social-media evolution towards homogeneity, reduction in quality, and eventual "injury"/disullusionment/backlash of people who were unprepared? -->
...
-   Note that *asking* and *answering* questions with *existing* infrastructure are all key here.
    ...
    -   *Answering* with *existing infrastructure*: Science proceeds by people building on each others ideas.
        ...
        <!--# Interestingly, Sam is an example of a collaborator who has worked well with us because exceeded a "threshold" of engaging with us in a meaningful way to learn about the challenges of the system, invested his own effort and did not expect to be fed samples/data/fieldwork; he used some extensive discussions to identify a knowledge gap and then fully owned that research. -->
        <!-- Contrast that to there has never been terribly successful collabs in the immunology space because no one has seemed to engage in that way for the Sierra, although they seem to have done so in Panama. -->
...
I have also placed comments above. 
...
-   Can the process of creating the open system and concept/knowledge model idenfify who the "gatekeepers" to that system are?
    Its natural that throughout a things life, a person will become its leader, authority, owner, point of contact, what have you.
    Gatekeepers are both beneficial and restrictive, because in a simultaneously Tolkienesque/Monty Pythonesque depiction, they can judge your readiness to proceed, decide if you shall, and helpfully point you on your way/mentor you (or cast you into eternal peril). 
    Are they Gandalf, or the Old Man from Scene 24?
